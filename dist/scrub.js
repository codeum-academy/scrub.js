...
var Sprite = (function () {
    ...
    Sprite.prototype.addCostume = function (costumePath, name, x, y, width, height, paddingTop, paddingRight, paddingBottom, paddingLeft) {
        ...
        image.addEventListener('load', function () {
            _this.addCostumeByImage(image, name, x, y, width, height, paddingTop, paddingRight, paddingBottom, paddingLeft);
        }, false);
    };
    Sprite.prototype.addCostumeByImage = function (image, name, x, y, width, height, paddingTop, paddingRight, paddingBottom, paddingLeft) {
        if (name === void 0) { name = null; }
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        if (width === void 0) { width = null; }
            ...
            for (var i = 0; i < rows; i++) {
                for (var t = 0; t < cols; t++) {
                    ...
                    if (!skip) {
                        ...
                        _this.addCostumeByImage(image, costumeName, x, y, chunkWidth, chunkHeight, paddingTop, paddingRight, paddingBottom, paddingLeft);
                        costumeIndex++;
                    }
                    x += chunkWidth;
                }
